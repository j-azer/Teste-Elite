...
namespace Projeto_Elite.Data.Migrations
{
    ...
    [Migration("20240722194634_AddContadorDownload")]
    partial class AddContadorDownload
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projeto_Elite.Models.Aluno", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projeto_Elite.Models.AlunoDisciplina", b =>
                {
            ...
            modelBuilder.Entity("Projeto_Elite.Models.Arquivo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ContadorDownload")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projeto_Elite.Models.AlunoDisciplina", b =>
                {
                    b.HasOne("Projeto_Elite.Models.Aluno", "Aluno")
                        .WithMany("AlunoDisciplinas")
                        .HasForeignKey("AlunoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Projeto_Elite.Models.Disciplina", "Disciplina")
                        .WithMany("AlunoDisciplinas")
